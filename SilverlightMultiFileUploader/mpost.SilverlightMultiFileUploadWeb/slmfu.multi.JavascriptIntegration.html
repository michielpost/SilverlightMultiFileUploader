...
<head>
    ...
    <script type="text/javascript">
        ...
        function ChangeCustomParams() {
            slCtl.Content.Files.CustomParams = "new value";
        }

        function ChangeFileFilter() {
            slCtl.Content.Configuration.FileFilter = "Images (*.jpg) | *.jpg";
        }
...
<body>
    ...
    <button onclick="ShowUploadProgress();">Javascript test: Show upload progress</button><br />
     <button onclick="ChangeCustomParams();">Javascript test: Change custom params</button><br />
     <button onclick="ChangeFileFilter();">Javascript test: Change
File Filter</button><br />
</body>
</html>
